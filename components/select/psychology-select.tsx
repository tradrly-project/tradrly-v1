...
export function PsychologySelect({
  name,
  selected,
  onChange,
  options,
  placeholder = "Psikologi",
  error,
  className,
}: PsychologySelectProps) {
  ...
  // Auto-scroll to right every time selected changes
  React.useEffect(() => {
  ...
  // Update fade indicator when scroll changes
  const updateFade = () => {
