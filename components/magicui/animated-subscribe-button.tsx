      ...
      <AnimatePresence mode="wait">
        {isSubscribed ? (
          <motion.button
            ref={ref}
            className={cn(
              "relative flex h-10 w-fit items-center justify-center overflow-hidden rounded-lg px-6 font-semibold",
              isSubscribed
                ? "bg-sky-600 text-white" // warna hijau untuk sukses/berhasil login
                : "bg-primary text-primary-foreground", // warna default
              className
            )}
